...
<body>
    ...
    <main>
        ...
        <div class="container">
            ...
            ?>
            <div class="p-2 flex-grow-1 bd-highlight fs-4">GẠO TẤM</div>
                <?php
                $sql = "SELECT * FROM product WHERE type = 'Gao_Tam'";
                    ...
                    <img src="../../Data/Gao/<?php echo $row['type'] . '/'; ?><?php echo $row['image'] ?>"
                        ...
                        <div class="d-flex justify-content-between mt-3"> 
                            <form action="addGao.php" method="post">
                                ...
                                <button type="submit" class="btn btn-primary btn-sm" name="addtocartT">Thêm vào giỏ hàng</button>
                            </form>
                        </div>
