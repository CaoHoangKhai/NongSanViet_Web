    ...
    <div class="container">
        <div class="row">
            <div class="col-14 offset-md-1">
                ...
                ?>
                <?php
                $sql = "SELECT * FROM order_customer WHERE id_user = '$id_user' ORDER BY id_order DESC LIMIT $begin,8";
                ...
                <?php
                    ...
                    echo '<img src="../../Data/Cart/ko_co_don_hang_1.png" alt="Bạn chưa có đơn hàng" class="img-fluid" style="width: 200px;">';
                    echo '</div>';
                    echo '</div>';
                }
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body row g-3 needs-validation">
                                ...
                                echo '<hr>' .
                                    ...
                                    '<strong class="ms-auto">' . number_format($row['price'], 0, ',', ',') . ' VND</strong>' .
                                    '</div>';
